                            ...
                            <form className="create-update-form" >
                                <div className="form-horizontal">
                                    ...
                                    <div className="form-group form-group-lg">
                                        <label className="col-md-3 control-label" htmlFor="plate_name">Plate Name:</label>
                                    ...
                                    <div className="form-group form-group-lg">
                                        <label className="col-md-3 control-label" htmlFor="protein">Protein:</label>
                                        <div className="col-md-4">
                                    ...
                                    <div className="form-group form-group-lg">
                                        <label className="col-md-3 control-label" htmlFor="side1">Side Dish 1:</label>
                                        <div className="col-md-4">
                                    ...
                                    <div className="form-group form-group-lg">
                                        <label className="col-md-3 control-label" htmlFor="side2">Side Dish 2:</label>
                                        <div className="col-md-4">
                                    ...
                                    <div className="form-group form-group-lg">
                                        <label className="col-md-3 control-label" htmlFor="side3">Side Dish 3:</label>
                                        <div className="col-md-4">
                                    ...
                                    <div className="form-group form-group-lg">
                                        <label className="col-md-3 control-label" htmlFor="quantity">Quantity Available:</label>
                                        <div className="col-md-4">
                                    ...
                                    <div className="form-group form-group-lg">
                                        <label className="col-md-3 control-label" htmlFor="preptime">Prep Time:</label>
                                        <div className="col-md-4">
                                    ...
                                    <div className="form-group form-group-lg">
                                        <label className="col-md-3 control-label" htmlFor="delaytime">Delay Time:</label>
                                        <div className="col-md-4">
