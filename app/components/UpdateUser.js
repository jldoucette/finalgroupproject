...
getusertoedit() {
    ...
    this.state = {
        ...
        RestID: this.props.userdetails.restID
    };
    ...
    enterInfo(event) {
        ...
        // helpers.updateuser(updateduserinput).then(function () {
        //     console.log("Updated User Component Completed");
        // });
                        ...
                        <form className="form-horizontal">
                            ...
                            <div className="form-group">
                                ...
                                <div className="col-md-7">
                                    <div className="input-group">
                                        ...
                                        <input type="text" id="last_name" value={this.state.LastName} className="form-control input-md" onChange={(event) => {
                                            this.setState({
                                                LastName: event.target.value
                                            })
                                        }}/>
                            ...
                            <div className="form-group">
                                ...
                                <div className="col-md-7">
                                    <div className="input-group">
                                        ...
                                        <input type="text" id="username" value={this.state.Email} name="username" className="form-control input-md" onChange={(event) => {
                                                this.setState({
                                                    Email: event.target.value
                                                })
                                            }}/>
                            ...
                            <div className="form-group">
                                ...
                                <div className="col-md-7">
                                    <div className="input-group">
                                        ...
                                        <input type="text" id="rest_id" value={this.state.RestID} name="rest_id" className="form-control input-md" onChange={(event) => {
                                            this.setState({
                                                RestID: event.target.value
                                            })
                                        }}/>
                            ...
                            <div className="form-group">
                                ...
                                <div className="col-md-7 offset-md-2">
                                    <button className="btn btn-success" onClick={this.enterInfo} type="submit"><span className="glyphicon glyphicon-thumbs-up"></span> Update User </button>
