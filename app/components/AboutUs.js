...
class AboutUs extends React.Component {
  ...
  render() {
    return (
      <div className="row">
        <h1> Who We Are </h1>
        <p><strong>LastCall</strong> is a service that is created to fulfill the demands for restaurants as well as for people that enjoy professionally prepared meals, but at a lower cost.
...
Typically this means minimizing wasted resources. There are many overhead costs to running a restaurant, and being able to maximize the value of sunken costs,  such as time already commited for employees that prepare food, and avoiding food waste.</p>
